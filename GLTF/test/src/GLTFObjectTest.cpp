...
rapidjson::StringBuffer writeObject(std::shared_ptr<GLTF::Object> object, GLTF::Options* options) {
...
TEST_F(GLTFObjectTest, WriteJSON_NoParameters) {
  std::shared_ptr<GLTF::Object> object(new GLTF::Object());
...
TEST_F(GLTFObjectTest, WriteJSON_WithExtra) {
  std::shared_ptr<GLTF::Object> object(new GLTF::Object());
  std::shared_ptr<GLTF::Object> extra(new GLTF::Object());
...
TEST_F(GLTFObjectTest, WriteJSON_WithExtension) {
  std::shared_ptr<GLTF::Object> object(new GLTF::Object());
  std::shared_ptr<GLTF::Extension> extension(new GLTF::Extension());
